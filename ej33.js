...
console.log(`Cantidad de usuarios con el incremento ${cantidadDeUsuarios}`);
// Se dieron de baja 3 usuarios
// Mostrar en consola la cantidad de usuarios en este momento y el mensaje: Cantidad de usuarios: cantidadDeUsuarios
cantidadDeUsuarios -= 3;
console.log(`Cantidad de usuarios con el decremento ${cantidadDeUsuarios}`);
// Compramos una empresa y los usuarios se duplicaron
// Mostrar en consola la cantidad de usuarios en este momento y el mensaje: Cantidad de usuarios: cantidadDeUsuarios
cantidadDeUsuarios *= 2;
console.log(`Cantidad de usuarios con la duplicación ${cantidadDeUsuarios}`);
...
// Mostrar en consola la cantidad de usuarios en este momento y el mensaje: Cantidad de usuarios: cantidadDeUsuarios
console.log(`Cantidad de usuarios hombres ${cantidadDeUsuarios / 2}`);
console.log(`Cantidad de usuarios mujeres ${cantidadDeUsuarios / 2}`);